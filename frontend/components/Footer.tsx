      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-blue-600 mb-4">IPX Protocol</h3>
            <p className="text-gray-600 mb-6 max-w-md">
              Fractional IP ownership on Internet Computer blockchain.
              Enabling creators to raise capital and investors to earn revenue.
            </p>
            <div className="flex space-x-4">
              ...
              <a href="#" className="w-10 h-10 bg-gray-700 text-white rounded-full flex items-center justify-center hover:bg-gray-800 transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/whitepaper" className="text-gray-600 hover:text-blue-600 transition-colors">
                  Whitepaper
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-gray-200 mt-10 pt-8 flex flex-col md:flex-row justify-between items-center">
          <div className="text-gray-500 text-sm mb-4 md:mb-0">
            © 2023 IPX Protocol. All rights reserved.
          </div>
